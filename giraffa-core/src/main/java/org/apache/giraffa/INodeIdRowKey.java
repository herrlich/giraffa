...
public class INodeIdRowKey extends RowKey implements Serializable {

  private static final long serialVersionUID = 123456789009L;

  private static final int DEPTH = 3;
  private static final int ID_SIZE = Long.SIZE / 8;
  private static final int LENGTH = ID_SIZE * DEPTH;
  private static final int LAST_ID_OFFSET = LENGTH - ID_SIZE;

  public static final INodeIdRowKey ROOT;
  public static final byte[] EMPTY;

  static {
    byte[] b = new byte[LENGTH];
    putLong(b, LAST_ID_OFFSET, 1000L);
    ROOT = new INodeIdRowKey("/", b);
  ...
  public INodeIdRowKey(String src, RowKey parent, long inodeId) {
    this.src = src;
    this.parent = parent;
    this.inodeId = inodeId;
  }

  public INodeIdRowKey(String src, byte[] bytes) {
    this(src, null, 0);
    this.bytes = bytes;
  }
  ...
  public String getKeyString() {
    ...
    for (int i = 0; i < LENGTH; i += ID_SIZE) {
      if (i > 0) sb.append('/');
